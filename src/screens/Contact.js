  ...
  return (
    <div className="w-screen flex font-Comfortaa">
      <div className="mb-[30px] ">
        <div className="p-[30px] bg-[#9dcbe0] w-full border-solid border-[1px] flex flex-wrap justify-center">
          <div className="card-body w-auto max-w-[300px] min-w-[70px] bg-[#9dcbe0] h-auto">
        ...
        <div className="flex flex-1 p-10 flex-row flex-wrap justify-center ">
          <div className="p-[30px] w-1/2 max-w-[400px] min-w-[300px]  m-4 border-solid border-[1px] border-[#9dcbe0] hover:shadow-2xl flex items-center justify-center flex-col">
          ...
          <div className="p-[30px] m-4 w-1/2 max-w-[400px] min-w-[300px]    border-solid border-[1px] border-[#9dcbe0] hover:shadow-2xl flex items-center justify-center flex-col">
