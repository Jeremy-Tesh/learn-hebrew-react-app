...
function Table() {
  ...
  return (
    <div className="w-screen h-screen p-10  grid place-items-center">
      <div className="w-[1300px] grid grid-cols-[15]  grid-row-14 ">
        {Array.from(Array(15), (e, i) => {
          return (
            <div
              className="w-[80px] h-[80px] flex flex-col relative items-center justify-center "
              style={{
                gridColumn: i + 1,
                gridRow: 0,
                backgroundColor: "red",
      ...
      <div className="w-[1300px] z-0 grid grid-cols-[15] gap-y-2 grid-row-8">
        {isShown ? (
          <div className="col-span-6 row-span-4 grid-cols-6 grid-rows-2">
            <Card />
          </div>
        ) : (
          ""
